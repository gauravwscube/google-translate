...
module_name =Label(root,text="Module Name",font=("Time New Roman",20,"bold"),bg="Red")
module_name.place(x=100,y=570,height=50,width=300)
module_name_1 =Label(root,text="pip install googletrans==3.1.0a0",bg="Red",font=("Time New Roman",20,"bold"))
module_name_1.place(x=0,y=620,height=50,width=500)
